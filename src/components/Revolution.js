  ...
  return (
    <Grid container direction="column">
        ...
        <Grid item container direction="column" lg style={{ maxWidth: "40em" }}>
          ...
          <Grid item>
            ...
            <Typography
              ...
              align={matchesMD ? "center" : undefined}
            >
              wo years later they shocked the world by releasing a similar
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={mockup} alt="" width="100%" style={{ maxWidth: 1000 }} />
        </Grid>
      </Grid>
      {/* sixth section end */}
      ...
      <Grid
        ...
        direction={matchesMD ? "column" : "row"}
        className={classes.rowContainer}
        style={{ backgroundColor: "#39B45A", height: "90em" }}
      >
        <Grid
          item
          container
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={design} alt="" style={{ maxWidth: 1000 }} width="100%" />
        </Grid>
      </Grid>
      {/* eighth section end */}
      {/* ninth section start */}
        ...
        >
          ...
          <Grid item>
            ...
            <Typography
              ...
              align={matchesMD ? "center" : undefined}
            >
              ach area is then developed in order of importance until ready to
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={launch} alt="" width="100%" style={{ maxWidth: 100 }} />
        </Grid>
      </Grid>
      {/* leventh section end */}
      {/* twelth section start */}
      <Grid
        item
        container
        direction={matchesMD ? "column" : "row"}
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={maintain} alt="" width="100%" style={{ maxWidth: 500 }} />
        </Grid>
      </Grid>
      {/* twelth section end */}
      {/* thirinth section start */}
      <Grid
        item
        container
        direction={matchesMD ? "column" : "row"}
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={iterate} alt="" width="100%"  />
        </Grid>
      </Grid>
      {/* thirinth section end */}
    </Grid>
  );
}
